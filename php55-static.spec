...
Source1: php55.conf
Source2: php55.ini
Source3: macros55.php
Source4: php55-fpm.conf
Source5: php55-fpm-www.conf
Source6: php55-fpm.service
Source7: php55-fpm.logrotate
Source8: php55-fpm.sysconfig
Source9: php55.modconf
Source10: php55.ztsmodconf
#Source11: strip.sh
# Configuration files for some extensions
Source50: opcache55.ini
Source51: opcache55-default.blacklist
Source99: php55-fpm.init

# Build fixes
Patch5: php-5.2.0-includedir.patch
Patch6: php-5.2.4-embed.patch
Patch7: php-5.5.11-recode.patch
...
Patch212: php55-locaweb-static.patch
...
cp %{SOURCE50} opcache%{?_suffix}.ini
...
%if %{without static}
sed -i "s/php55/php/g" $RPM_BUILD_ROOT%{_sysconfdir}/php%{?_suffix}.d/php.ini
%endif
...
%if %{without static}
sed -i -e 's/php55_module/php5_module/g' -e 's/libphp55/libphp5/g' \
    -e 's/php55/php/g' $RPM_BUILD_ROOT%{_httpd_confdir}/php%{?_suffix}.conf
%endif
%else
...
%if %{without static}
sed -i -e "s/php55_module/php5_module/g" -e "s/libphp55/libphp5/g" \
    "s/php55/php/g" $RPM_BUILD_ROOT%{_httpd_modconfdir}/10-php%{?_suffix}.conf \
...
%if %{without static}
sed -i "s/php55/php/g" $RPM_BUILD_ROOT%{_sysconfdir}/php%{?_suffix}-fpm.conf \
...
sed -e '/blacklist_filename/s/php%{?_suffix}.d/php%{?_suffix}-zts.d/' \
    -i $RPM_BUILD_ROOT%{_sysconfdir}/php%{?_suffix}-zts.d/opcache.ini

sed -i "s/php55/php/g" $RPM_BUILD_ROOT%{_sysconfdir}/php%{?_suffix}.d/opcache.ini \
    $RPM_BUILD_ROOT%{_sysconfdir}/php%{?_suffix}-zts.d/opcache.ini
...
%if %{without static}
sed -i "s/php55/php/g" $RPM_BUILD_ROOT%{macrosdir}/macros%{?_suffix}.php
%endif
...
%if %{with static}
# PHP 5.3/5.4 compatibility mode (Locaweb Shared Hosting)
...
%doc fpm_LICENSE
%attr(1777,root,webserver) %dir %{_localstatedir}/lib/php%{?_suffix}/session
%attr(1777,root,webserver) %dir %{_localstatedir}/lib/php%{?_suffix}/wsdlcache
...
%changelog
* Thu Oct 24 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.18-1
- Merged with Remi changes:
  Update to 5.5.18
  http://www.php.net/releases/5_5_18.php

* Mon Sep 22 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.17-2
- Merged with Remi changes:
  openssl: fix regression introduce in changes for upstream
  bug #65137 and #41631, revert to 5.5.16 behavior

* Thu Sep 19 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.17-1
- Merged with Remi changes:
  Update to 5.5.17
...
* Thu Sep 11 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.16-2
- Add _suffix 55

* Mon Sep  1 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.16-1
- Merged with Remi changes:
  Update to 5.5.16
  http://www.php.net/releases/5_5_16.php
  fix zts-php-config --php-binary output #1124605
  enable libvpx on EL 6

* Mon Aug 18 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.15-1
- Merged with Remi changes:
- Update to 5.5.15
  http://www.php.net/releases/5_5_15.php

* Wed Jul 16 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.14-2
- Merged with Remi changes:
- add upstream patch for #67605

* Thu Jul 10 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.15-0.1.RC1
- Merged with Remi changes:
- Test build of 5.5.15RC1
- add php-litespeed subpackage (/usr/bin/lsphp)

* Fri Jun 28 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.14-1
- Merged with Remi changes:
- Update to 5.5.14
...
* Thu Jun  5 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.13-3
- Merged with Remi changes:
- fix regression introduce in fix for #67118

* Tue Jun  3 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.13-2
- Merged with Remi changes:
...
* Wed May 28 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.13-1
- Merged with Remi changes:
- Update to 5.5.13
  http://www.php.net/releases/5_5_13.php
- sync php.ini with upstream php.ini-production

* Thu May 15 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.12-5
- Enable with_zip

* Thu May 15 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.12-4
- Enable php_bootstrap

* Thu May 15 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.12-3
- Fix opcache.ini

* Wed May 14 2014 Claudio Filho <claudio.filho@locaweb.com.br> 5.5.12-2
...
- Fix php-recode patch and rename to php-5.5.11-recode.patch
- Add icuconfig patch
- Add locaweb static patch
- Add php55 prefix on all files
- Remove Obsoletes
...
- Add %preun and %post to rename php55.conf
- Fix %clean session order, this session must be before %files.
- Fix includedir and php binary name on php55-config and zts-php55-config
